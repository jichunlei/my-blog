...
public class CodeGeneration {
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/blog?useUnicode=true&characterEncoding=utf-8");
        ...
        strategy.setInclude(new String[]{"t_blog", "t_blog_tags", "t_tag", "t_type", "t_user"});//需要生成的表

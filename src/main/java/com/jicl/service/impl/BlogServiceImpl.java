...
public class BlogServiceImpl implements BlogService {
    ...
    public Long countBlog(Integer userId) {
        ...
        BlogExample.Criteria criteria =
                blogExample.createCriteria().andDelFlagEqualTo(false).andPublishedEqualTo(true);
        if (userId != null) {
    ...
    public void addBlog(Blog blog) {
        ...
        redisValueUtil.hPut(RedisConstant.LIKE_KEY, blog.getBlogId().toString(),
                new HashSet<Integer>());
